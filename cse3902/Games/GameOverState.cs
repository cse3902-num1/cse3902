...
namespace cse3902.Games
{
    public class GameOverState : IGameState
    {
        ...
        public void Draw(Camera camera)
        {
            ...
            camera.spriteBatch.DrawString(Game1.font, gameOver, textPos, Color.Red,0f,new Vector2(30,10),6, SpriteEffects.None, 0f);
            camera.spriteBatch.DrawString(Game1.font, startOver, textPos, Color.DarkRed, 0f, new Vector2(100, -20), 3, SpriteEffects.None, 0f);
            camera.EndDraw();
        }
